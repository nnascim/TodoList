...
extension UITableView {
    ...
    ///
    /// - Parameters:- cellType: Name of xib to register
    ...
    ///
    /// - Parameter for: The index path specifying the location of the cell. The data source receives this information when
